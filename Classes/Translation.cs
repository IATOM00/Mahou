...
namespace Mahou
{
    static class Translation
    {
        ...
        public static string[] UIRU = new string[] {
          /*///////////////Main UI\\\\\\\\\\\\\\\
          /*00-03*/"Mahou","Автозапуск з Windows","","Гарячі клавіші",
          /*04-06*/"Конв. слова","Конв. виділення", "Конв. рядка",
          /*07-10*/"CS-Switch","Повт. натиск.","Повт. виділ.","Зміна розкладки клавішею:",
          /*11-14*/"Блок CTRL","Іконка трея","Циклічн. режим","Ему",
        ...
        public static string[] ToolTipsRU = new string[] {
          ...
          /*08*/"Тип перемикання залежить від \"Циклічн. режим\" і \"Ему\".",
        ...
        public static string[] MessagesRU = new string[] {
          ...
          "************WINDOWS 10 Metro-застосунки************\nУвімкніть \"Циклічн. режим\", \"Ему\" і встановіть тип емуляції на \"Win+Space\". Ці налаштування краще працюють для Metro-застосунків.\n\nЩоб скинути налаштування, просто видаліть Mahou.ini у папці Mahou.\n\nУспіхів.",
